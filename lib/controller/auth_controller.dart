...
import 'package:kriyeta_event_manage/core/utils.dart';
import 'package:kriyeta_event_manage/models/user_model.dart';
import 'package:kriyeta_event_manage/repository/auth_repository.dart';
  ...
  Future<void> checkUserAlreadyLoggedIn(BuildContext context) async {
    if (FirebaseAuth.instance.currentUser == null) {
      Future.delayed(Duration(seconds: 2), () {
        Navigator.pushNamedAndRemoveUntil(
            context, AppRouter.onboard, (route) => false);
      });
    } else {
      await _ref
