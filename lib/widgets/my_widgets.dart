...
Widget elevatedButton({text, Function? onpress}) {
  return ElevatedButton(
    style: ButtonStyle(
      backgroundColor: MaterialStateProperty.all<Color>(Pallete.blue),
    ),
    onPressed: () {
      onpress!();
    },
...
Widget iconTitleContainer(
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      border: Border.all(width: 0.1, color: Pallete.genderTextColor),
    ),
    width: width,
    height: height,
    child: TextFormField(
    ...
    children: [
      path.toString().isEmpty
          ? Container(
              ...
              height: 24,
              decoration:
                  BoxDecoration(shape: BoxShape.circle, color: Pallete.blue),
              child: Icon(
                Icons.person,
                color: Colors.white,
              ),
